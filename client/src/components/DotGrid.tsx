...
const DotGrid = ({
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined') {
      (window as any).addEventListener('mousemove', throttledMove as EventListener, { passive: true });
      (window as any).addEventListener('click', onClick as EventListener);
    }

    return () => {
      if (typeof window !== 'undefined') {
        (window as any).removeEventListener('mousemove', throttledMove as EventListener);
        (window as any).removeEventListener('click', onClick as EventListener);
      }
    };
